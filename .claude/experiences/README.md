...
| [2026-07-24-repo-skills-and-manual-site-deploy.md](2026-07-24-repo-skills-and-manual-site-deploy.md) | Kept Claude and Codex use independent from the landing page, with read-only install-free onboarding and guarded local Pages uploads |
| [2026-07-24-portable-plugin-first-architecture.md](2026-07-24-portable-plugin-first-architecture.md) | Corrected the clone-first design: the full skill now carries its runtime into any host project, with Cloudflare state isolated under `.cloudflare-maxxing/` |
| [2026-07-24-public-launch.md](2026-07-24-public-launch.md) | Made the repository public after the release gate, then verified anonymous links and a credential-free clone |
| [2026-07-30-free-tier-audit-and-workers-paid.md](2026-07-30-free-tier-audit-and-workers-paid.md) | Account-wide free-tier audit found blown Pages builds and a Worker over CPU budget; Workers Paid ($5/month) beat both engineering fixes, plus a Pages branch-control API footgun worth remembering |
| [2026-07-30-account-hardening-batch.md](2026-07-30-account-hardening-batch.md) | Usage alerts, per-IP rate limits, Managed WAF, per-Worker CPU caps, and the SSL/HSTS/DNSSEC baseline in one audited batch; findings 30 to 11, and Cloudflare's missing spend cap replaced with layers |
| [2026-08-01-preview-deployments-shutdown.md](2026-08-01-preview-deployments-shutdown.md) | Previews off on all 5 Pages projects + 3 Workers, 765 stray URLs deleted to zero; supersedes the July leave-alone call, fixes the branch-includes footgun for good, and the deletion sweep must loop until dry |
| [2026-08-12-access-otp-silent-policy-mismatch.md](2026-08-12-access-otp-silent-policy-mismatch.md) | Access OTP never arriving was a silent policy mismatch (one-time PIN only sends on an allow-policy match); new access-policy-email action fixes membership per app, metrics console tightened from everyone to named emails |
