 ...
 * Fires on two matchers (see .claude/settings.json): Bash, and
 ...
 *   1. .claude/settings.json  → "ask" on mutating MCP tools, action scripts,
 *                                 and mcp__cloudflare__execute.
 ...
 *
 * To temporarily disable: remove the PreToolUse hooks from .claude/settings.json.
 */
